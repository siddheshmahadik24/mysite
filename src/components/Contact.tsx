      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-white/50 text-base mb-12 leading-relaxed">
            Whether it's a collaboration, opportunity, or just a conversation —
            I'd love to hear from you.
          </p>

          <a
            href={`mailto:${siteContent.email}`}
            className="inline-block bg-amber-400 text-slate-900 px-10 py-3.5 rounded font-semibold text-sm tracking-wide hover:bg-amber-300 transition-colors mb-14"
          >
            {siteContent.email}
          </a>
